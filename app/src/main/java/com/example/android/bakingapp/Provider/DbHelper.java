...
import com.example.android.bakingapp.Provider.RecipeContract.RecipeEntry;
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_PLANTS_TABLE = "CREATE TABLE " + RecipeEntry.TABLE_NAME + " (" +
                ...
                RecipeEntry.COLUMN_REIPE_NAMES + " STRING NOT NULL, " +
                RecipeEntry.COLUMN_RECIPE_INGREDIENTS + " STRING NOT NULL)";
