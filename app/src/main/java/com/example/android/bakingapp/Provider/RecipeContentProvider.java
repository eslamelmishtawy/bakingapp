...
import static com.example.android.bakingapp.Provider.RecipeContract.RecipeEntry;
...
public class RecipeContentProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        // Add URI matches
        uriMatcher.addURI(RecipeContract.AUTHORITY, RecipeContract.PATH, RECIPES);
        uriMatcher.addURI(RecipeContract.AUTHORITY, RecipeContract.PATH + "/#", RECIPE_WITH_ID);
        return uriMatcher;
    }
    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            ...
            case RECIPE_WITH_ID:
                ...
                plantsDeleted = db.delete(RecipeEntry.TABLE_NAME, "_id=?", new String[]{id});
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
    ...
    public int update(@NonNull Uri uri, ContentValues values, String selection,
        ...
        switch (match) {
            case RECIPES:
                plantsUpdated = db.update(RecipeEntry.TABLE_NAME, values, selection, selectionArgs);
                break;
            case RECIPE_WITH_ID:
